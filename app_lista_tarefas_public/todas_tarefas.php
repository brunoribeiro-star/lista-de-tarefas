...
<head>
    ...
    <script>
        ...
        function aplicarFiltro() {
            ...
            location.href = 'todas_tarefas.php?status=' + status + '&categoria=' + categoria + '&criterio=' + criterio + '&ordem=' + ordem;
        }
    </script>
</head>
<body>
                                ...
                                foreach ($tarefas as $tarefa) { ?>
                                    <div class="row mb-3 d-flex align-items-center tarefa">
                                        <div class="col-sm-9" id="tarefa_<?= $tarefa->id ?>">
                                            <?= htmlspecialchars($tarefa->tarefa) ?> (<?= htmlspecialchars($tarefa->status) ?>)
                                        </div>
